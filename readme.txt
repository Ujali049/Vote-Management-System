...
5. Make a folder named "votesytem" and store all the files there.
 
5.Paste the project inside root directory/ where you install xammp local disk C: drive D: drive E: paste: (for xampp/htdocs, 
